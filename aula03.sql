...
-- Funcionam por referência ( no programa chamador )

-- Params do tipo IN OUT
-- Recebe um valor de entrada e pode (ou não) devolver um valor modifiado
-- Funcionam por cópia ( na área de memória da procedure )

-- NOCOPY
-- Os Params do tipo IN OUT funcionam por referência
